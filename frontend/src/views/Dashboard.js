...
import data from './datasetApi.js';
...
const filteredData = data.filter((item) => item.Manufacturer === 'Airbus');
...
const series = [
  ...
  filteredData.slice(0, 5).map((item) => item['Energy Consumption - Recycled Parts (kWh)']),
];
// const series = seriesdata.slice(0, 100);
// console.log(series);
const filteredData1 = data.filter((item) => item.Manufacturer === 'Boeing');
const totalParts = filteredData.length;

// Get the number of used parts by filtering the data by condition and getting the length of the resulting array
const usedParts = filteredData1.filter((item) => item.Condition === 'Used').length;

// Get the number of new parts by filtering the data by condition and getting the length of the resulting array
        ...
        <Row>
          <Col md="6">
            <Card>
              ...
              <Card.Footer>
                <div className="legend">Water Usage
                  <i className="fas fa-circle text-info"></i>
                  Landfill Waste <i className="fas fa-circle text-danger"></i>
                  BMW 5 Series
                </div>
                <hr></hr>
                <div className="stats">
